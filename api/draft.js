export default async function handler(req, res) {
    ...
    6. **การยึดลูกค้า**: ถ้าสินค้าหมด พยายามยึดลูกค้าไว้ เช่น การขอเบอร์ติดต่อเพื่อแจ้งเมื่อสินค้าเข้า หรือการให้มัดจำเพื่อล็อคคิวสินค้าแน่นอน อย่างกระตือรือร้น เพื่อดึงลูกค้าไว้ให้ได้ อยากขายมาก
